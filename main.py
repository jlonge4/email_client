...
category = input("Type in the category to delete from...eg primary, promotions \n ")
subject = input("Type in the SENDER to delete mail from...\n")

gmail_search = f'"category:{category} {subject}"'
print(f' deleting mail from: {gmail_search}')
